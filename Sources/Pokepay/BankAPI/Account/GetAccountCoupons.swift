...
public extension BankAPI.Account {
    @available(*, deprecated, message: "Use Autogen.BankAPI.Account.GetAccountCoupons instead. This hand-written request is being replaced by the auto-generated Autogen API.")
