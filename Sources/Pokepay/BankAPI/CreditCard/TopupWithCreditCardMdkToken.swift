...
public extension BankAPI.CreditCard {
    @available(*, deprecated, message: "Use Autogen.BankAPI.CreditCard.TopupWithCreditCardMdkToken instead. This hand-written request is being replaced by the auto-generated Autogen API.")
