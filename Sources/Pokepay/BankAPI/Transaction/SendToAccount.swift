...
public extension BankAPI.Transaction {
    @available(*, deprecated, message: "Use Autogen.BankAPI.Account.SendToAccount instead. This hand-written request is being replaced by the auto-generated Autogen API.")
