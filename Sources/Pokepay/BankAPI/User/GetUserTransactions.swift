...
public extension BankAPI.User {
    @available(*, deprecated, message: "Use Autogen.BankAPI.User.GetUserTransactions instead. This hand-written request is being replaced by the auto-generated Autogen API.")
