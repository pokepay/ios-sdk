...
public extension BankAPI.Cashtray {
    @available(*, deprecated, message: "Use Autogen.BankAPI.Cashtray.UpdateCashtray instead. This hand-written request is being replaced by the auto-generated Autogen API.")
